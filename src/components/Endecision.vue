<template>
  ...
  <div class="indecision-container">
      ...
      <input type="text" placeholder="Hazme una pregunta" v-model="newQuestion">
...
export default {
    ...
    methods:{
        async obtenerRespuesta() { // con este metodo realizamos nuestra petición http
    ...
    watch: {
        newQuestion( value, oldValue) { 
            ...
            this.obtenerRespuesta(); // mandamos a traer el metodo por separado
